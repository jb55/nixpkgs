...
{ stdenv, fetchurl, ghc, perl, gmp, ncurses, libiconv, jemalloc }:
...
stdenv.mkDerivation (rec {
  ...
  buildInputs = [ ghc perl gmp ncurses jemalloc ];
  ...
  meta = {
    ...
    maintainers = with stdenv.lib.maintainers; [ marcweber andres simons jb55 ];
